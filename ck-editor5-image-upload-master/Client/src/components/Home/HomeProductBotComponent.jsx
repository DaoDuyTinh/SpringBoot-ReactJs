...
class HomeProductBotComponent extends React.Component{
  constructor(props){
    super(props)
    this.state={
        content:[],
...
findAll(currentPage){
  currentPage-=1;
  ProductService.getProductBot(currentPage,this.state.size)
...
render (){
    return (
      <div style={{marginLeft:'60px',marginRight:'20px'}} >
          <section className="padding-bottom-sm titleall">
          <header className="section-heading heading-line">
            <h4 className="title-section text-uppercase"style={{color:"#ae0d0d"}}>Xe tay ga</h4>
          </header>
          <div>
                    ...
                    <div className="product-item">
                      ...
                      <span className="badge badge-danger" style={{position:"absolute"}}>Trả góp 0%</span>
                        <a href="product-detail.html">
                          <img
                            className="img-sm"
                            style={{ marginLeft: "-2px",width:"250px",height:"200px" ,textDecoration:"none"}}
...
export default HomeProductBotComponent
