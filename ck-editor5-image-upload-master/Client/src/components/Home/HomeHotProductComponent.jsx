...
class HomeHotProductComponent extends React.Component{
    constructor(props){
        super(props)
        this.state={
            product:[]
    ...
    render (){
      ...
      <h4 className="title-section text-uppercase"style={{color:"#ae0d0d"}}>Phụ kiện<img src={"http://localhost:8080/images/phutung.jpg"} style={{width: '40px'}}/> </h4>
          </header>
...
export default HomeHotProductComponent
